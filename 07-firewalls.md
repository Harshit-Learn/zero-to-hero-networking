...
# 🔥 Firewalls & Security Groups ( Day-7)
...
Network Security Fundamentals: In networking, security is based on controlling what traffic is allowed:
...
Firewall remembers:
"Connection from 192.168.1.10:54321 to 93.184.216.34:443"
...
Firewall checks:
"Is this a response to an existing connection?"
...
Allow port 22 from specific IP

---

2. Use Security Groups, Not IP Addresses
