...
* Host or network interface identification - Uniquely identifies a device
...
CIDR Solution: Allows network masks of any length, not just 8, 16, or 24 bits.
